...
class MainActivity : AppCompatActivity() {
    ...
    /** Para que InicioFragment y otros fragmentos puedan cambiar de pestaña */
    ...
    /** Abre ExpedienteFragment. Si pacienteId no es null, carga el expediente existente. */
    ...
    /**
     * Abre ConsultaFragment para un paciente.
     * @param paciente   El paciente dueño de la consulta.
     * @param consultaId Si es null, se crea una nueva. Si tiene valor, se edita la existente.
     */
